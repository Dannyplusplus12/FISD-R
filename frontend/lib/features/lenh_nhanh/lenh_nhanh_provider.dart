...
class TrangThaiLenhNhanh {
  ...
  bool get dangTai =>
      trangThai == TrangThaiLenh.dangPhanTich || trangThai == TrangThaiLenh.dangTao;
}
  ...
  Future<void> phanTich(String lenh) async {
    ...
    try {
      ...
      state = TrangThaiLenhNhanh(
        ...
        thongBaoLoi: e.toString(),
      );
    }
  }

  Future<void> taoDon({int? nhanVienId}) async {
...
final lenhNhanhProvider = NotifierProvider<LenhNhanhNotifier, TrangThaiLenhNhanh>(
